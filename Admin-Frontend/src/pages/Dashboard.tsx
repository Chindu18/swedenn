                  ...
                  {bookings.map((b, i) => (
                    <TableRow key={b.bookingId}>
                      ...
                      <TableCell>
                        ...
                        <span className="text-sm text-muted-foreground">{formatTime(b.timing)}</span>
                      </TableCell>
                      <TableCell className="text-center">
                        <button
                          ...
                          className={`relative inline-flex items-center h-6 w-16 rounded-full transition-colors duration-300 ${
              ...
              {bookings.map((b, i) => {
                ...
                return (
                  <div
                    ...
                    className="border p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-all duration-200 cursor-pointer"
                  >
